import image from "./images/product-img-1.jpg";
import image2 from "./images/product-img-2 (1).jpg";
import image3 from './images/product-img-10.jpg';
import image4 from './images/product-img-8.jpg';
...
let details = [
    ...
    {
        "Productname": "Ammul Butter",
        "Productdetails": "Corn flour, also known as maize flour, is a type of flour made from finely ground dried corn kernels. It's a versatile ingredient with various uses in cooking and baking.",
        "Productimage": image4,
    },
    {
        "Productname": "Kellogg's Cornflakes",
        "Productdetails": "Each delicious Corn Flake is simply a kernel of real golden corn, matured and naturally sundried in the field. It ripens in 140 days of sunshine, and is then rolled and toasted to perfection to give you that iconic golden crisp crunchiness.The product is very useful.",
        "Productimage": image6,
    },
    {
        "Productname": "Peanut Butter",
        "Productdetails": "A rich, creamy spread made from ground peanuts, packed with protein and healthy fats. Perfect for spreads or smoothies.",
        "Productimage": image5,
    },
    {
